...
class GA_POP_Configuration
{
  ...
  */
  public function page_init()
  {
    ...
    if ( isset($_POST['ga_pop_setting']) ) {
      ...
      $this->options['expired_ival'] = $input['expired_ival'];
      if( ! isset( $this->options['expired_ival'] ) || $this->options['expired_ival'] === '' || $this->options['expired_ival'] < 1 ) {
        $this->errors['expired_ival'] = "Please input Show List";
      }
  ...
  */
  public function create_admin_page()
  {
    ...
    $expired_ival = isset($this->options['expired_ival']) ? $this->options['expired_ival'] : $GA_POP_DEFAULT_CACHE_EXPIRED_IVAL;;
      ...
      <form  enctype="multipart/form-data" method="post">
        ...
        <table class="form-table">
          <table>
            ...
            <tr>
              <th>Cache Expired Interval</th>
              <td>:</td>
              <td><input type="number" name="ga_pop_setting[expired_ival]" value="<?php echo $expired_ival?>" required/> hours</td>
            </tr>
            <tr>
              <th>Date From</th>
              <td>:</td>
              <td><input type="number" name="ga_pop_setting[date_from]" value="<?php echo $date_from;?>" required/> Days Ago</td>
            </tr>
            <tr class="urls">
